...
const PostCard = ({ post }) => {
  return (
    ...
    hover:text-yellow-600 text-3xl font-semibold
    '>
    ...
    {post.excerpt}
      ...
      <div className='text-center'>
        <Link href={`/post/${post.slug}`}>
          <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-yellow-700 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer'>
              continue reading
          </span>
        </Link>
      </div>
